...
import { ArrowRight, GlobeHemisphereWest, Headset } from "@phosphor-icons/react";
    ...
    <div className="site-shell">
      ...
      <header className="site-header">
        <Link className="brand" href={`/${locale}`} onClick={() => setNavigating(true)} aria-label={locale === "zh" ? "云桥首页" : "CloudBridge home"}>
          <span className="brand-mark"><Image src="/assets/cloudbridge-logo.png" width={28} height={28} priority alt="" /></span>
          <span>
            <strong>{t.brandPrimary}</strong>
        ...
        <footer id="support" className="site-footer">
          <div className="footer-brand">
            <span className="footer-brand__mark" aria-hidden="true">
              <Image src="/assets/cloudbridge-logo.png" width={52} height={30} alt="" />
            </span>
      ...
      <SupportDrawer locale={locale} onClose={closeSupport} open={supportOpen} />
    </div>
  );
}
